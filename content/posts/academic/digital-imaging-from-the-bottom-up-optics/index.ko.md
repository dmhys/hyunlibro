...
지금까지는 이상적인 카메라라도 피할수 없는 영역이었다. 회절은 빛의 성질 때문에 일어나는 현상이었다. 굴절은 초점면, 즉 카메라가 세상과 센서 사이의 1대1 매핑을 확실하게 할 수 있는 영역이 한정되어서 일어나는 일이었다. 그러나 실제 카메라의 경우 그렇지 않다. **초점면 위의 점이라도 실제로 하나의 점으로 맺히지 못한다.**
